...
const testimonials: Testimonial[] = [
  {
    name: "Aranya Patil",
    text: "Prime Digital School helped me build real-world skills and confidence in technology.",
    rating: 5,
  },
  {
    name: "Sneha Kapoor",
    text: "The hands-on projects and expert mentors completely transformed my learning experience.",
    rating: 5,
  },
  {
    name: "Rohan Mehta",
    text: "Best decision for my career — the curriculum is perfectly aligned with industry needs.",
    rating: 5,
  },
  {
    name: "Priya Sharma",
    text: "I loved the collaborative environment and real-world projects. Highly recommend!",
    rating: 5,
  },
  {
    name: "Aryan Verma",
    text: "The faculty and support team are incredible. I feel future-ready!",
    rating: 5,
  },
];
    ...
    <main className="min-h-[40dvh] overflow-x-hidden w-full">
      <section className="w-full md:h-[40dvh] lg:h-[100dvh] mt-1 lg:mt-0 mx-auto relative flex items-center overflow-hidden ml-2 md:ml-4 md:pl-4  max-[600px]:flex-col max-[600px]:items-stretch max-[600px]:overflow-visible max-[600px]:pt-2">
        <div className="w-[36%] max-[900px]:w-[45%] max-[600px]:w-full relative z-[5] pb-[92px] max-[900px]:pb-[60px] max-[600px]:pb-5">
          ...
          <h1 className="max-w-[520px] mt-[18px] mb-4 [font-family:var(--font-playfair),Georgia,serif] text-[clamp(32px,3.5vw,48px)] max-[720px]:text-[28px] leading-none tracking-[-1.7px] max-[720px]:tracking-[-1px] text-[#111111] font-bold">
            ...
            <span className="text-[var(--primary)]">Digital Skills</span>
          </h1>
          ...
          <div className="flex items-center gap-[18px] mt-7 max-[720px]:flex-col max-[720px]:items-stretch flex-wrap">
            <Link
              href="/programs"
              className="min-h-[44px] inline-flex items-center justify-center gap-[11px] px-5 rounded-[13px] text-[14px]  transition-all duration-300 ease-in-out bg-gradient-to-br from-[var(--primary)] to-[var(--primary-dark)] hover:-translate-y-[3px] max-[720px]:w-full w-full lg:w-1/2 font-extrabold text-white"
            >
            ...
            <Link
              href="/about"
              className="min-h-[44px] inline-flex items-center justify-center gap-[11px] px-5 rounded-[13px] text-[14px] font-black no-underline transition-all duration-300 ease-in-out bg-white text-[var(--primary)] border border-[rgba(122,0,25,0.42)] hover:-translate-y-[3px] max-[720px]:w-full"
            >
      ...
      <section className="w-49/50 max-[1180px]:w-[min(100%-48px,1320px)] max-[720px]:w-[min(100%-28px,1320px)] relative z-12 grid grid-cols-[repeat(4,1fr)_1.45fr] max-[1180px]:grid-cols-[repeat(2,1fr)] max-[720px]:grid-cols-2 items-center gap-0 mx-auto md:mt-[-100px] lg:mt-[-50px] max-[1180px]:mt-6 p-[26px] px-[42px] max-[1180px]:p-[26px_28px] max-[720px]:p-6 max-[720px]:rounded-[20px] rounded-[18px] bg-gradient-to-r from-[var(--primary-dark)] via-[var(--primary)] to-[var(--primary-light)] text-white shadow-[0_24px_60px_rgba(90,0,18,0.28)] overflow-hidden">
        {stats.map(({ icon: Icon, value, label }, i) => (
          <div
            key={label}
            className={`min-h-[86px] flex items-center gap-4 px-[30px] max-[720px]:px-0 max-[720px]:py-[18px] ${i === 0 ? "pl-0" : ""} max-[720px]:border-b max-[720px]:border-[rgba(255,255,255,0.12)] border-r max-[1180px]:border-r-0 last:border-r-0 border-[rgba(255,255,255,0.16)] max-[720px]:justify-center max-[720px]:text-center ${i >= 2 ? "max-[720px]:border-b-0" : ""}`}
          >
            <Icon
              size={44}
              className="w-11 h-11 shrink-0 stroke-[1.8] max-[720px]:w-8 max-[720px]:h-8"
            />
            <div>
              <strong className="block text-[34px] max-[720px]:text-[22px] leading-none font-black">
                {value}
              </strong>
              <span className="block mt-[6px] text-[15px] max-[720px]:text-[13px] leading-[1.35] text-[rgba(255,255,255,0.82)]">
                {label}
              </span>
            </div>
          </div>
          ...
          {[...testimonials, ...testimonials].map((t, i) => (
            <div className="pds-review-card" key={i}>
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <div className="font-semibold text-[15px] leading-tight text-[#1C1B1B]">
                    {t.name}
                  </div>
              ...
              <p className="text-[14px] leading-[1.6] text-[#3f3f46] m-0">
                {t.text}
              </p>
            </div>
          ))}
        ...
        <div className="w-full max-w-[1280px] flex flex-col gap-10">
          <div className="w-full max-w-[1232px] bg-white shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] rounded-3xl overflow-hidden flex flex-col md:flex-row relative z-10 mx-auto">
              ...
              <form className="flex flex-col gap-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex flex-col gap-2">
                    <label className="text-sm font-semibold text-[#1C1B1B] tracking-[0.7px]">
                      Full Name
                    </label>
                    <input
                      type="text"
                      className="h-[50px] px-4 rounded-xl border border-[#DDBFC2] bg-[#FCF9F8] focus:outline-none focus:border-[#6B0025]"
                    />
                  </div>
                  <div className="flex flex-col gap-2">
                    <label className="text-sm font-semibold text-[#1C1B1B] tracking-[0.7px]">
                ...
                <button
                  type="submit"
                  className="bg-[#6B0025] text-white px-8 py-4 rounded-xl text-sm font-semibold tracking-[0.7px] hover:bg-[#8B1C3A] transition-colors w-fit mt-2"
                >
                  SEND MESSAGE
                </button>
              </form>
            ...
            <div className="w-full md:w-1/2 bg-[#8B1C3A] p-8 md:p-16 flex flex-col justify-between">
                ...
                <div className="flex flex-col gap-5">
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-base text-white leading-[24px]">
                      Prime Digital School, Sector 17, Vashi, Navi Mumbai
                    </span>
                  </div>
                  <div className="flex items-center gap-4">
              ...
              <div className="mt-10 h-[180px] w-full overflow-hidden rounded-2xl bg-white md:h-[256px]">
                <iframe
